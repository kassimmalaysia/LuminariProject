 ...
 */
export declare type variant = "h1" | "h2" | "h3" | "h4" | "h5" | "h6" | "lead" | "paragraph" | "small";
export declare type color = "inherit" | "current" | "black" | "white" | colors;
export declare type asType = ElementType;
export declare type textGradient = boolean;
